module.exports = {
	...
	"configs": {
		...
		"ts-front": {
			...
			"rules": {
				"@typescript-eslint/no-explicit-any": "off" // [off] generate an error
			}
	...
	"rules": {
		...
		// plugins
			...
			"@stylistic/max-len": [ "warn", { "ignorePattern": true, "ignoreRegExpLiterals": true, "ignoreComments": true } ], // [warn] should not be used, but tolerated
			"@stylistic/max-statements-per-line": [ "error", { "max": 2 } ],
			"@stylistic/multiline-ternary": "warn", // [warn] should not be used, but tolerated
			"@stylistic/new-parens": "error",
			"@stylistic/newline-per-chained-call": "warn", // [warn] should not be used, but tolerated
			...
			"@stylistic/padded-blocks": ["error", { "classes": "always", "switches": "always" } ],
