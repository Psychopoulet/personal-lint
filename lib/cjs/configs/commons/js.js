...
module.exports = {
    ...
    "rules": {
        ...
        "max-classes-per-file": [ "warn", // [warn] can be tolerated for libs
        ...
        "max-lines-per-function": [ "warn", // [warn] should not be used, but tolerated for old or complex files
            { "skipBlankLines": true, "skipComments": true }
        ],
        ...
        // plugins
            ...
            "@stylistic/max-len": [ "warn", // [warn] should not be used, but tolerated
                {
                    "ignoreComments": true,
